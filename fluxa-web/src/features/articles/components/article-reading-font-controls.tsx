...
export function ArticleReadingFontControls({ children }: ArticleReadingFontControlsProps) {
  ...
  return (
    ...
    >
      {children}
      <aside className="fixed bottom-4 right-4 z-50 w-[min(13.5rem,calc(100vw-2rem))] rounded-lg border border-white/12 bg-[#07101f]/92 p-3 text-white shadow-[0_18px_60px_rgba(0,0,0,0.38)] backdrop-blur-md">
